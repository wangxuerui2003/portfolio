...
export default function Skills() {
	return (
		<section
			id="skills"
			className="w-full px-6 lg:px-24 bg-background flex flex-col justify-start items-center flex-grow gap-6"
		>
			<div className="flex mt-12 lg:mt-24 items-center gap-4">
				<h1 className="font-bold text-4xl lg:text-6xl">Skills</h1>
				<Image
					src="/icons/coding-skills.png"
					width={64}
					height={64}
					alt="Skills"
				/>
			...
			<div className="mt-4 lg:mt-6 space-y-2 mb-2">
				<SkillsIcons
					skillName="Languages"
